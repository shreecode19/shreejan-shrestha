        ...
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 lg:gap-8">
          ...
          >
            ...
            <p className="text-base md:text-lg text-foreground/70 leading-relaxed max-w-xl mx-auto lg:mx-0 mb-8">
              I'm a passionate designer and student dedicated to creating user-friendly and visually appealing
              designs. I focus on blending aesthetics with functionality to craft intuitive and engaging user
              experiences. Constantly learning and growing, I aim to turn creative challenges into effective
              design solutions.
            </p>
          ...
          >
            <div className="relative w-[280px] h-[340px] md:w-[350px] md:h-[420px] lg:w-[400px] lg:h-[480px]">
              {/* Splash background */}
              <motion.img
                src={splashImg}
                alt=""
                className="absolute w-[140%] h-[140%] -left-[20%] -top-[20%] object-contain z-0 opacity-90"
                animate={{ 
                  y: [0, -15, 0],
                  x: [0, 10, 0],
                  rotate: [0, 5, 0],
              ...
              <img
                ...
                className="relative z-10 w-full h-full object-cover object-top rounded-3xl shadow-lift"
              />
            </div>
          </motion.div>
        </div>
